namespace sixteenBars.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<sixteenBars.Models.SixteenBarsDb>
    {
        ...
        private void SeedMembership()
        {
            ...
            if (membership.GetUser("jsaunders", false) == null) {
                membership.CreateUserAndAccount("jsaunders", "dudley");
            }
            if (!roles.GetRolesForUser("jsaunders").Contains("Admin")) {
                roles.AddUsersToRoles(new[] { "jsaunders" }, new[] { "admin" });
            }
        }
