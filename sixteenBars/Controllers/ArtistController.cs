...
namespace sixteenBars.Controllers
{
    public class ArtistController : Controller
    {
        ...
        public ActionResult NameDetails(string artistname)
        {
            ...
            Artist artist = _db.Artists.SingleOrDefault(a => a.Name.Replace(".", "").Replace(",", "").Replace("&", "").Replace("?", "").Replace("%", "").Replace("!", "").Replace("*", "").Replace(":", "").Replace("<", "").Replace(">", "").Replace("\\", "").Replace(";", "").Replace("/", "").Replace("#","").ToLower() == artistname.ToLower().Trim());
