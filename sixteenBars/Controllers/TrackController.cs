...
namespace sixteenBars.Controllers
{
    public class TrackController : Controller
    {
        ...
        public ActionResult TitleTitleDetails(string albumtitle, string tracktitle)
        {
            ...
            ViewBag.MetaDescription = "Hip-Hop track/song";
            ViewBag.MetaKeywords = "Hip-Hop, hip hop, track, song, rap, music";
            Track track = _db.Tracks.SingleOrDefault(t => t.Album.Title.Replace(".", "").Replace(",", "").Replace("&", "").Replace("?", "").Replace("%", "").Replace("!", "").Replace("*", "").Replace(":", "").Replace("<", "").Replace(">", "").Replace("\\", "").Replace(";", "").ToLower() == albumtitle.ToLower().Trim() && t.Title.Replace(".", "").Replace(",", "").Replace("&", "").Replace("?", "").Replace("%", "").Replace("!", "").Replace("*", "").Replace(":", "").Replace("<", "").Replace(">", "").Replace("\\", "").Replace(";", "").ToLower() == tracktitle.ToLower().Trim());
            if (track != null)
            {
